...
let virtual-env = "K:\Универ\ПрограммнаяИнженерия\Индивидуалка\TelegramBot\venv"
let bin = "Scripts"
let path-sep = ";"
...
alias deactivate = source "K:\Универ\ПрограммнаяИнженерия\Индивидуалка\TelegramBot\venv\Scripts\deactivate.nu"
